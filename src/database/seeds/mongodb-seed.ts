...
export async function seedMongoDB(documentModel: Model<any>) {
  ...
  const documents = [
    {
      projectId: '1', // You'll need to get actual IDs from MySQL
    ...
    },
    {
      ...
      content: 'Complete guide to employment law and regulations in the United States...',
    ...
    },
    {
      ...
      content: 'Step-by-step guide for registering a business entity in Germany...',
    ...
    },
    {
      ...
      content: 'Understanding Japanese business etiquette and cultural considerations...',
    ...
    },
    {
      ...
      content: 'Comprehensive overview of Brazilian tax system for foreign companies...',
